...
function Card({ thumbnailUrl, title, description, dateString, url }: Props) {
  ...
  return (
    <div className="grid grid-flow-row lg:grid-flow-col  gap-2 py-10 place-items-center">
      ...
      <div className="lg:mr-auto mx-10">
        ...
        <div className="text-white text-m mx-0 md:mx-12 lg:mx-0  text-left md:text-center lg:text-left font-generalSans lg:w-3/4">
          {description}
        </div>
      </div>
      <br />
